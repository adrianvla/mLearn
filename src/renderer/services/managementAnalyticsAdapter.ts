...
const REJECTION_CODES = new Set(['invalid_schema', 'invalid_event', 'invalid_activity', 'invalid_progress', 'title_too_long', 'event_too_old', 'event_too_new', 'active_group_mismatch', 'invalid_scope', 'id_conflict', 'sequence_conflict', 'duplicate_in_batch'])
type RejectionCode = 'invalid_schema' | 'invalid_event' | 'invalid_activity' | 'invalid_progress' | 'title_too_long' | 'event_too_old' | 'event_too_new' | 'active_group_mismatch' | 'invalid_scope' | 'id_conflict' | 'sequence_conflict' | 'duplicate_in_batch'
