...
const Anki: Component<AnkiProps> = (props) => (
  <svg width="24" height="24" viewBox="0 0 50 50" fill="none" class={props.class} xmlns="http://www.w3.org/2000/svg">
    <path fill={props.color} d="M37.38,2H12.84C9.66,2,7,4.85,7,8v7.26c10.89,1.54,25.87,5.9,36,13.65V7.62C43,4.54,40.46,2,37.38,2z M38.93,13.68
