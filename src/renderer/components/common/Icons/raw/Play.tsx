...
const Play: Component<PlayProps> = (props) => (
  <svg width="24" height="24" viewBox="-0.5 0 7 7" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill={props.color}>
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <defs> </defs>
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" class={props.class} fill-rule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-347.000000, -3766.000000)" fill={props.color}>
