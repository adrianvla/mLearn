/**
 * Subtitle Components Index
 * Export all subtitle-related components
 */
...
export { LiveWordTranslator } from './LiveWordTranslator';
export { SubtitleSync, type SubtitleSyncProps } from './SubtitleSync';