...
const mockElectronBridge: PlatformBridge = {
  ...
  plugins: {} as PlatformBridge['plugins'],
  ...
  updates: {} as PlatformBridge['updates'],
  ...
  knowledgeEvents: {} as PlatformBridge['knowledgeEvents'],
  watchTogether: {} as PlatformBridge['watchTogether'],
  overlay: {} as PlatformBridge['overlay'],
  ...
  browser: {} as PlatformBridge['browser'],
  diagnostics: {} as PlatformBridge['diagnostics'],
};
