...
contextBridge.exposeInMainWorld('mLearnIPC', {
    ...
    startInstall: (options) => ipcRenderer.send('start-install', options),
    requestInstallerState: () => ipcRenderer.send('installer-state-request'),
    ...
    onFlashcardConnectOpen: (callback) => ipcRenderer.on('flashcard-connect-open', (event, message) => callback(message)),
